...
def recommend(movie):
    ...
    return recommended_movies, recommended_movie_posters, recommended_movie_years, recommended_movie_ratings
...
# Load the data files
try:
    movies = pickle.load(open('artifacts/movie_dict.pkl', 'rb'))
